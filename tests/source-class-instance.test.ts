...
describe("source-class-instance", {timeout: 100}, () => {
	
	it("should call method of class with prefix", {timeout: 100}, async () => {
	...
	it("should call method of class with bound prefix", {timeout: 100}, async () => {
